          ...
          <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex flex-col gap-2 rounded-xl p-6 border border-slate-200 dark:border-[#3d3b54] bg-white dark:bg-[#1c1c27] shadow-sm transition-all hover:border-primary/30">
                ...
                <p className="text-slate-900 dark:text-white text-3xl font-black tabular-nums font-display">$42,500.00</p>
                    ...
                    {filteredPayouts.map((payout) => (
                      ...
                      >
                        ...
                        <td className="hidden sm:table-cell px-6 py-4">
                          <div className="flex justify-center">
                            <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider flex items-center gap-1.5 ${
                              payout.method === 'Stripe' ? 'bg-indigo-100 text-indigo-600 dark:bg-indigo-900/40 dark:text-indigo-400' :
                        ...
                        <td className="px-4 md:px-6 py-4 text-right">
                          <button className={`text-[10px] font-black uppercase tracking-[0.1em] px-3 md:px-4 py-1.5 md:py-2 rounded-lg transition-all ${
                            payout.status === 'Reviewing' 
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <label key={i} className="flex items-start gap-3 cursor-pointer group">
                      <div className={`mt-0.5 rounded border-2 size-4 flex items-center justify-center transition-all ${
                        check.checked ? 'bg-primary border-primary text-white shadow-sm' : 'border-slate-300 dark:border-[#3d3b54] group-hover:border-primary'
                      }`}>
